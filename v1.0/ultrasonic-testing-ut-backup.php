				...
				<div class="title_holder">
					...
					<div class="industify_fn_breadcrumbs">
						<ul>
							...
							<li class="separator"><span></span></li>
							<li><span class="bread-current">Ultrasonic Testing (UT)</span></li>
						</ul>
					</div>
				</div>
			</div>
								 		...
								 		<ul>
											<li>
									   			<div class="item">
													...
													<p>Deep penetration capability</p>
									   			</div>
											</li>
											<li>
									   			<div class="item">
										  			...
										  			<p>Accurate thickness measurement</p>
									   			</div>
											</li>
											<li>
									   			<div class="item">
											...
											<li>
									   			<div class="item">
										 			...
										 			<p>Cost-effective inspection method</p>
									   			</div>
											</li>
								 		</ul>
							  		</div>
