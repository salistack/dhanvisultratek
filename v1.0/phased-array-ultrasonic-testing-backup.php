				...
				<div class="title_holder">
					...
					<div class="industify_fn_breadcrumbs">
						<ul>
							...
							<li class="separator"><span></span></li>
							<li><span class="bread-current">Phased Array Ultrasonic Testing (PAUT)</span></li>
						</ul>
					</div>
				</div>
			</div>
								 		...
								 		<ul>
											<li>
									   			<div class="item">
													...
													<p>High-resolution defect detection</p>
									   			</div>
											</li>
											<li>
									   			<div class="item">
										  			...
										  			<p>Accurate flaw sizing and positioning</p>
									   			</div>
											</li>
											<li>
									   			<div class="item">
										  			...
										  			<p>Faster inspection with digital data recording</p>
									   			</div>
											</li>
											<li>
									   			<div class="item">
										 			...
										 			<p>Suitable for weld inspections and critical components</p>
									   			</div>
											</li>
								 		</ul>
							  		</div>
								 		...
								 		<ul>
											...
											<li>
									   			<div class="item">
										 			...
										 			<p>Structural integrity evaluation</p>
									   			</div>
											</li>
								 		</ul>
							  		</div>
