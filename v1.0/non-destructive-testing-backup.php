				...
				<div class="title_holder">
					...
					<div class="industify_fn_breadcrumbs">
						<ul>
							...
							<li class="separator"><span></span></li>
							<li><span class="bread-current">Non-Destructive Testing (NDT)</span></li>
						</ul>
					</div>
				</div>
			</div>
					 	...
					 	<div class="full-width-service">
							<div class="r_inner">
						  		<div class="top_section">
							  		<img src="vl_img/ndt.jpg">
						   		</div>
						   		<div class="bottom_section">
								<div class="excerpt_holder p-break">
									<p>NDT involves inspection techniques used to evaluate materials and structures without causing damage.</p>
								</div>
								
								<div class="service-sub-division-vl">
								<div class="title">
								 		...
								 		<ul>
											...
											<li>
									   			<div class="item">
										  			...
										  			<p>Phased Array Ultrasonic Testing (PAUT)</p>
									   			</div>
											</li>
											<li>
									   			<div class="item">
										 			...
										 			<p>Radiographic Testing (RT) coordination</p>
									   			</div>
											</li>
											<li>
									   			<div class="item">
										 			...
										 			<p>Inspection reporting & evaluation</p>
									   			</div>
											</li>
								 		</ul>
							  		</div>
								 		...
								 		<ul>
											...
											<li>
									   			<div class="item">
										 			...
										 			<p>Material integrity assessment</p>
									   			</div>
											</li>
								 		</ul>
							  		</div>
