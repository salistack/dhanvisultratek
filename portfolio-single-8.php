		...
		<div class="industify_fn_portfolio_single">
			...
			<div class="fn_cs_justified_wrap">
				<div class="fn_cs_justified fn_cs_lightgallery" data-height="380" data-gutter="5">
					<a class="lightbox" href="" data-src="img/portfolio/single/8/1.jpg">
						<img src="img/portfolio/single/8/1.jpg" alt="" />
						<span class="plus"></span>
					</a>
					<a class="lightbox" href="" data-src="img/portfolio/single/8/2.jpg">
						<img src="img/portfolio/single/8/2.jpg" alt="" />
						<span class="plus"></span>
					</a>
					<a class="lightbox" href="" data-src="img/portfolio/single/8/3.jpg">
						<img src="img/portfolio/single/8/3.jpg" alt="" />
						<span class="plus"></span>
					</a>
					<a class="lightbox" href="" data-src="img/portfolio/single/8/4.jpg">
						<img src="img/portfolio/single/8/4.jpg" alt="" />
						<span class="plus"></span>
					</a>
					<a class="lightbox" href="" data-src="img/portfolio/single/8/5.jpg">
						<img src="img/portfolio/single/8/5.jpg" alt="" />
						<span class="plus"></span>
					</a>
					<a class="lightbox" href="" data-src="img/portfolio/single/8/6.jpg">
						<img src="img/portfolio/single/8/6.jpg" alt="" />
						<span class="plus"></span>
					</a>
					<a class="lightbox" href="" data-src="img/portfolio/single/8/7.jpg">
						<img src="img/portfolio/single/8/7.jpg" alt="" />
						<span class="plus"></span>
					</a>
					<a class="lightbox" href="" data-src="img/portfolio/single/8/8.jpg">
						<img src="img/portfolio/single/8/8.jpg" alt="" />
						<span class="plus"></span>
					</a>
				</div>
			</div>
						...
						<div class="content_part">
							...
							<div class="share_box">
								<div class="industify_fn_share_icons">
									<label>Share:</label>
									<ul>
										<li><a href="http://www.facebook.com/sharer.php?u=https://frenify.net/envato/frenify/html/industify/1/portfolio-single-8.html" target="_blank"><i class="xcon-facebook"></i></a></li>
										<li><a href="https://twitter.com/share?url=https://frenify.net/envato/frenify/html/industify/1/portfolio-single-8.html" target="_blank"><i class="xcon-twitter"></i></a></li>
										<li><a href="https://plus.google.com/share?url=https://frenify.net/envato/frenify/html/industify/1/portfolio-single-8.html" target="_blank"><i class="xcon-gplus"></i></a></li>
										<li><a href="http://pinterest.com/pin/create/button/?url=https://frenify.net/envato/frenify/html/industify/1/portfolio-single-8.html&amp;" target="_blank"><i class="xcon-pinterest"></i></a></li>
										<li><a href="https://www.vk.com/sharer.php?url=https://frenify.net/envato/frenify/html/industify/1/portfolio-single-8.html" target="_blank"><i class="xcon-vkontakte"></i></a></li>
									</ul>
								</div>
							</div>
